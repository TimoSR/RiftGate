...
namespace Infrastructure.UtilityServices.Token;
...
public class TokenHandler : ITokenHandler
{
    ...
    public TokenHandler(ICustomConfiguration customConfiguration, ILogger<TokenHandler> logger)
    {
        _jwtSettings = new JwtSettings
        {
            PlaintextKey = customConfiguration.JwtKey,
            EncryptionKey = customConfiguration.JwtEncryptionKey,
            Issuer = customConfiguration.JwtIssuer,
            Audience = customConfiguration.JwtAudience,
            ExpirationInHours = 6
        };
